...
using Search.API.Infrastructure.EventHandlers;
...
namespace Search.API
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<NewProductAddedIntegrationEventHandler>();
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1", new Info
                {
                    Title = "Search API",
                    Version = "v1",
                    Description = "The Search Service API",
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            eventBus.Subscribe<NewProductAddedIntegrationEvent, NewProductAddedIntegrationEventHandler>();
